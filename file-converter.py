...
st.write("Uplaod CSV or Excel files, clean data, and convert formats")

files = st.file_uploader("Upload CSV or Excel files.", type=["cvs", "xlsx"], accept_multiple_files=True)
